...
2. In a separate terminal, run the Ali app with the `-dev` flag:
...
**Dependencies** - either build a local copy of Ali, or use a github release
```powershell
# Local dependencies
