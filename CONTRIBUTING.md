...
Thank you for your interest in contributing to Ali! Here are a few guidelines to help you started.

## Set up

See the [development documentation](./docs/development.md) for instructions on how to build and run Ali locally.
