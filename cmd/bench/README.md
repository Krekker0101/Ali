...
A Go-based command-line tool for benchmarking Ali models with configurable parameters, warmup phases, TTFT tracking, VRAM monitoring, and benchstat/CSV output.
